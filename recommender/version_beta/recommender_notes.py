...
#####
perf_names, vec_top, vec_mid, vec_base = notes_vec_prep(perf_overlap, language)
...
for i in range(nUsers):
    ...
    user_top, user_mid, user_base = user_vec_prep(user_perfume, user_sentiment)
    temperature = np.array((1, 2, 1, 1.5), dtype=int)
    rec_list = recommender_notes(perf_names, vec_top, vec_mid, vec_base, user_top, user_mid, user_base, temperature)